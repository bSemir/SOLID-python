# instead of doing int with classes and subclasses, we can also use composition
...
# a separate class that handles auth
...
class SMSAuthorizer:
    ...
    def is_authorized(self) -> bool:  # returns bool
